...
{
    public function __construct(private string $rootElementName = 'rows', private string $rowElementName = 'row', private string $attributePrefix = '_', private string $dateTimeFormat = 'Y-m-d\TH:i:s.uP', private ?XMLWriter $xmlWriter = null)
    {
        $this->xmlWriter = $xmlWriter ?? new DOMDocumentWriter();
    }
